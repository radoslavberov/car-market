...
const features = [
	...
	{
		title: 'Имоти',
		description: 'Подробна информация за всеки имот. Направете сравнение между имотите, които ви интересуват.',
		image: gallery[2],
	},
	{
		title: 'Анализи',
	...
	},
	{
		...
		description:
			'Информация за имоти от множество източници. Търсете и сравнявайте, използвайки богат набор от филтри.',
		image: gallery[3],
	},
];
