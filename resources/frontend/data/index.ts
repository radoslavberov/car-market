...
export const getEstate = async (id: any): Promise<Estate> => {
	return api.get(`/api/estates/${id}`).then((res) => {
		return res.data.data;
	});
};
...
export const getProviders = async (): Promise<Provider[]> => {
	return api.get('/api/providers').then((res) => {
		return res.data.data;
	});
};

export const getEstateAnalyses = async (id: any): Promise<Analysis[]> => {
	return api.get(`/api/estates/${id}/analyses`).then((res) => {
		return res.data.data;
	});
};

export const getEstateTypes = async (): Promise<EstateType[]> => {
	return api.get('/api/estate-types').then((res) => {
		return res.data.data;
	});
};
